...
export class $npmConfigName1741375035053 implements MigrationInterface {
  name = ' $npmConfigName1741375035053';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "dev"."person" ("id" SERIAL NOT NULL, "names" character varying NOT NULL, "lastNames" character varying NOT NULL, "cedula" character varying NOT NULL, "fechaNacimiento" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL, "updatedAt" TIMESTAMP NOT NULL, "personAddressId" integer, CONSTRAINT "REL_426c6600dd278c3507bab66ce9" UNIQUE ("personAddressId"), CONSTRAINT "PK_5fdaf670315c4b7e70cce85daa3" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "dev"."person" ADD CONSTRAINT "FK_426c6600dd278c3507bab66ce9e" FOREIGN KEY ("personAddressId") REFERENCES "dev"."personAddress"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "dev"."person" DROP CONSTRAINT "FK_426c6600dd278c3507bab66ce9e"`,
    );
    await queryRunner.query(
